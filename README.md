...
- `.md`、`.markdown` 和 `.mdown` 使用独立的 Markdown 文档图标，不再复用应用程序图标。
- 文件图标采用浅色文档页和高对比度 `M↓` 标记，在资源管理器小尺寸视图中仍可辨认。
- 应用程序、默认应用列表和右键菜单继续使用原有 JS Kern.md 应用图标。
