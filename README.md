...
- 语言和主题设置迁入独立设置弹窗，原工具栏位置改为设置按钮。
- 设置弹窗新增 Markdown 文件关联状态与 Windows 默认应用入口。
- 管理员安装器会注册 Markdown 默认应用候选和 Explorer 入口，但不会强制覆盖用户的系统默认选择。
