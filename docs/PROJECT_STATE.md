...
- Latest validation after dedicated Markdown file icon v0.1.21:
  ...
  - GitHub Release `v0.1.21` was created at `https://github.com/xiaotianwm/jskern.md/releases/tag/v0.1.21` and verified as the latest release.
  - Release tag `v0.1.21` resolves to source commit `916974b7eacd422f0be7a1291d11225e56919c44`.
  - GitHub Release asset verification passed: installer label/name are `JSKernMD-Setup-0.1.21-x64.exe`, checksum label/name are `SHA256SUMS.txt`, installer size is `7358751` bytes, and the installer digest is `sha256:0ac337c581a2566b2e5bb01e42ad945bd12baed1b51996163276277c7b2cbcd8`.
...
- Latest validation after settings and Markdown association v0.1.19:
  ...
  - `git diff --check` passed after removing Wails-generated template substitutions and trailing whitespace.
  - GitHub Release `v0.1.19` was created at `https://github.com/xiaotianwm/jskern.md/releases/tag/v0.1.19` and verified as the latest release.
  - Release tag `v0.1.19` resolves to source commit `8f6937046b20d6475a98ee23bc99f3a4448a01c3`.
  - GitHub Release asset verification passed: installer label/name are `JSKernMD-Setup-0.1.19-x64.exe`, checksum label/name are `SHA256SUMS.txt`, installer size is `7330992` bytes, and the installer digest is `sha256:f678d94c284d43f16fc795492be42af7f9756ae736b664bc0c90a1a92fdce078`.
