export namespace main {
	...
	export class WorkspaceTree {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.workspace = this.convertValues(source["workspace"], WorkspaceEntry);
	...
	export class WorkspaceCollection {
	    ...
	    static createFrom(source: any = {}) {
	        return new WorkspaceCollection(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.workspaces = this.convertValues(source["workspaces"], WorkspaceTree);
	...
	export class LaunchRequest {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.collection = this.convertValues(source["collection"], WorkspaceCollection);
